-- Use the correct database (uppercase PBVSI-SULUT)
USE `PBVSI-SULUT`;

-- Create settings table for website configuration (MySQL/MariaDB)
...
-- Insert default settings if not exists (MySQL compatible)
