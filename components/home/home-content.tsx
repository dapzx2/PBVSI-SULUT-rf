...
export function HomeContent({ articles }: HomeContentProps) {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <main>
                {/* Hero Section */}
                <section className="relative min-h-[60vh] md:min-h-[85vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-orange-600 via-orange-700 to-red-800 text-white pt-16">
                    ...
                    <div className="container mx-auto px-4 relative z-10">
                        ...
                        >
                            ...
                            <h1 className="text-3xl md:text-7xl lg:text-8xl font-extrabold tracking-tight mb-6 md:mb-8 leading-tight">
                                PBVSI <span className="text-orange-200">Sulut</span>
                            </h1>
                            <p className="text-base md:text-2xl text-orange-50 mb-8 md:mb-10 max-w-3xl mx-auto leading-relaxed font-light">
                    ...
                    <div className="container mx-auto">
                        <div className="grid lg:grid-cols-12 gap-8 md:gap-12 items-start">
                            ...
                            <motion.div
                                ...
                                transition={{ duration: 0.8 }}
                            >
                                <div className="bg-white rounded-3xl p-6 md:p-12 shadow-xl border border-gray-100 h-full">
                                    ...
                                    <div className="prose prose-lg max-w-none text-gray-600 leading-relaxed space-y-6">
                                        ...
                                        <div className="bg-orange-50 border-l-4 border-orange-600 p-6 rounded-r-xl my-8">
                                            <p className="text-base md:text-lg font-medium text-gray-900 italic mb-2">
                    ...
                    <div className="container mx-auto relative z-10">
                        <div className="flex flex-col md:flex-row justify-between items-end mb-8 md:mb-12 gap-6">
                            ...
                            >
                                ...
                                <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Seputar PBVSI</h2>
                                <p className="text-gray-600 mt-2 text-base md:text-lg">Update terkini dari lapangan dan kegiatan organisasi</p>
                            </motion.div>
                        ...
                        {articles && articles.length > 0 ? (
                            <motion.div
                                className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8 items-stretch"
                            ...
                            >
                                {articles.map((article) => (
                                    <motion.div variants={fadeInUp} key={article.id} className="h-full">
