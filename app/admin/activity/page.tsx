...
import { Loader2, Clock, UserPlus, Trophy, FileText, ImageIcon, AlertCircle } from "lucide-react"
    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Daftar lengkap aktivitas yang tercatat dalam sistem.</CardDescription>
        </CardHeader>
        <CardContent>
          {loading ? (
            <div className="flex justify-center items-center h-48">
              <Loader2 className="h-8 w-8 animate-spin text-orange-600" />
              <p className="ml-2 text-gray-600">Memuat aktivitas...</p>
            </div>
          ) : error ? (
            ...
            <div className="space-y-4">
              {activities.length === 0 ? (
                <p className="text-center text-gray-500">Tidak ada aktivitas yang ditemukan.</p>
              ) : (
