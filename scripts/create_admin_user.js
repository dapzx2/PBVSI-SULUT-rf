...
var mysql_1 = require("../lib/mysql");
function createDefaultAdmin() {
    return __awaiter(this, void 0, void 0, function () {
        var _a, adminUser, error, e_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, 3, 4]);
                    console.log("Attempting to create default admin user...");
                    return [4 /*yield*/, (0, admin_1.createAdminUser)({
                ...
                case 1:
                    _a = _b.sent(), adminUser = _a.adminUser, error = _a.error;
                    if (error) {
                ...
                case 2:
                    e_1 = _b.sent();
                    console.error("An unexpected error occurred:", e_1.message);
                    return [3 /*break*/, 4];
                case 3:
                    mysql_1.default.end(); // Close the database connection pool
                    return [7 /*endfinally*/];
